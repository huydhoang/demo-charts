...
const Home: NextPage = () => {
  return (
    <div className={styles.container}>
      <Head>
        <title>Charts</title>
        <meta name='description' content='Charts made with Apache Echarts' />
        <link rel='icon' href='/favicon.ico' />
      </Head>

      <main className={styles.main}>
        <h1 className={styles.title}>Welcome to Charts!</h1>
        ...
        <div className={styles.grid}>
          <div className={styles.card}>
            <h2>Complex Pie Chart</h2>
            <ReactECharts option={chart4Opt} cssProps={ChartStyle} />
            <p>A visualization of retail sales data.</p>
          </div>

          <div className={styles.card}>
            <h2>Shanghai Composite Index</h2>
            <ReactECharts option={sseData} cssProps={ChartStyle} />
            <p>
              The SSE Composite Index also known as SSE Index is a stock market
              index of all stocks that are traded at the Shanghai Stock
              Exchange.
            </p>
          </div>
          ...
          <div className={styles.card}>
            <h2>Scatter Plot</h2>
            <ReactECharts option={heightWeightData} cssProps={ChartStyle} />
            <p>Height and Weigth distribution based on survey data.</p>
          </div>

          <div className={styles.card}>
            <h2>Radar Chart</h2>
            <ReactECharts option={radarData} cssProps={ChartStyle} />
            <p>
              A visualization of budget vs. actual spending data by division.
            </p>
          </div>
        </div>
      </main>
